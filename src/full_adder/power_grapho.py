...
def main():
    ...
    instance_cell_mapping, instance_cell_base_mapping, instance_pin_mapping = parse_netlist_rtl('full_adder.v')
    ...
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label='Flip Flops', markerfacecolor='red', markersize=10),    # Para sumador 1 bit no hay FF
